...
GRANT SELECT, INSERT, DELETE, UPDATE ON SANPHAM TO DT1
GRANT UPDATE ON DONHANG(TINHTRANG) TO DT1
GRANT SELECT ON DONHANG TO DT1
GRANT INSERT, UPDATE ON DOITAC TO DT1
GRANT SELECT ON HOPDONG TO DT1
	
--Gán quyền cho tài xế
GRANT SELECT, INSERT ON TAIXE TO TX1
GRANT UPDATE ON TAIXE(HOTX,TENTX,SDTTX,DIACHITX,BIENSOXE,EMAILTX,TKNGANHANG,PHITHECHAN) TO TX1
GRANT UPDATE ON DONHANG(TINHTRANG) TO TX1
GRANT SELECT ON DONHANG TO TX1

--Gán quyền cho hhách hàng
GRANT SELECT, INSERT, UPDATE ON KHACHHANG TO KH1
GRANT SELECT ON SANPHAM TO KH1
GRANT SELECT ON DONHANG TO KH1

-- Gán quyền cho nhân viên
GRANT SELECT, INSERT, DELETE, UPDATE ON HOPDONG TO NV1
GRANT SELECT, UPDATE ON TAIKHOAN(PASSWD) TO NV1
...
GO
GRANT SELECT, UPDATE, INSERT, DELETE ON DTV_DTSANPHAM TO DT1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT, INSERT, UPDATE ON DTV_DOITAC TO DT1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT ON DTV_DTHOPDONG TO DT1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT, UPDATE, INSERT, DELETE ON KHV_SANPHAM TO KH1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT ON KHV_DONHANG TO KH1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT, INSERT, UPDATE ON KHV_KHACHHANG TO KH1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT, INSERT, UPDATE ON TXV_DTTX TO TX1
...
WHERE TK.TENTK = CURRENT_USER
GO
GRANT SELECT, UPDATE ON TXV_DTDH TO TX1
